          ...
          <div class="nav-wrapper container">
            ...
            <ul id="nav-mobile" class="side-nav white z-depth-5">
              ...
              <li id="musicLinkMob" class="blue-grey-text text-darken-4">
                <a href="/music"><i class="tiny mdi-av-volume-up left 1  blue-grey-text text-darken-4"></i>Music</a>
              </li>
              <li id="computingLinkMob" class="blue-grey-text text-darken-4">
                <a href="/computing"><i class="tiny mdi-hardware-desktop-windows left blue-grey-text text-darken-4"></i>Computing</a>
              </li>
              <li id="aboutLinkMob" class="blue-grey-text text-darken-4">
                <a href="/about"><i class="tiny mdi-social-person left blue-grey-text text-darken-4"></i>About Me</a>
              </li>
              <li id="contactLinkMob" class="blue-grey-text text-darken-4">
                <a href="/contact"><i class="tiny mdi-communication-email left blue-grey-text text-darken-4"></i>Contact</a>
              </li>
            </ul>
